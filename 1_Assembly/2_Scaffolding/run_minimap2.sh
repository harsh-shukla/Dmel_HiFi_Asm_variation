...
ASM=../contamination_rem/iso1.asm.bp.p_ctg.CntRem.mitproc.fasta


~/Softwares/minimap2/minimap2-2.24_x64-linux/minimap2 -t 32 -x asm10 $REF $ASM  > ISO1Contig_to_ISO1rel6.paf
