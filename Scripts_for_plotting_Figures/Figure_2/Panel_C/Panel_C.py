...
color_dic = {'92_Repeat_rRNA':'xkcd:grey blue','329_Repeat_rRNA':'xkcd:grey blue','240_Repeat_rRNA':'xkcd:grey blue','rRNA':'xkcd:kelly green','R1_DM':'xkcd:light orange','R2_DM':'xkcd:orange','Stellate':'xkcd:brick red','LTR':'xkcd:sky blue','LINE':'xkcd:blue','DNA':'xkcd:indigo','Low_complexity':'xkcd:pale yellow','Simple_repeat':'xkcd:bright yellow','NA':'xkcd:white'}
