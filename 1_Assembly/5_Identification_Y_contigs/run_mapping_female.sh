...
FASTQ_R1=SRR6399449_1.fastq.gz
FASTQ_R2=SRR6399449_2.fastq.gz
CURR_SRA=SRR6399449
STRAIN=ISO1F
THREADS=32
NAME=ISO1fem
...
samtools coverage -q 20 $NAME.sorted.bam > female.coverage
samtools coverage $NAME.sorted.bam > female.q0.coverage
