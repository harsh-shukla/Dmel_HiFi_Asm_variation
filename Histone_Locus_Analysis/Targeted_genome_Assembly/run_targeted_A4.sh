...
HIFI_READS=/dfs7/jje/hgshukla/HiFi_Subreads/A4/CCS_gen_6_2/Qv_gt_099/A4_hifi_099.min6k.fasta.gz


minimap2 -ax map-hifi -t 32 ../../a4.asm.bp.p_ctg.fasta $HIFI_READS | samtools sort -@ 32 -O bam - > A4hifi.reads.mapped.bam
samtools index A4hifi.reads.mapped.bam
samtools view ptg000013l:13864361-14485421 A4hifi.reads.mapped.bam | awk -F"\t" '{print $1}' | sort | uniq > histone_mapped.lst
