...
color_dic = {'Stellate':'xkcd:brick red','Satellite':'xkcd:grey blue','rRNA':'xkcd:kelly green','LTR':'xkcd:grey','LINE':'xkcd:light grey','DNA':'xkcd:almost black','Low_complexity':'xkcd:grey blue','Simple_repeat':'xkcd:grey blue','NA':'xkcd:white','RC/Helitron':'xkcd:dark grey'}
